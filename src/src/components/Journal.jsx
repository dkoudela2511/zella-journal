...
.dash-cal .cal-grid{gap:4px;}
.dash-cal .cal-cell{aspect-ratio:auto;min-height:44px;padding:5px 7px;border-radius:8px;gap:0;}
.dash-cal .cal-d{font-size:11px;}
.dash-cal .cal-pnl{font-size:11.5px;}
.dash-cal .cal-n{font-size:9px;}
.dash-cal .cal-wl{font-size:9px;}
